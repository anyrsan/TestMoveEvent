...
public class SubViewData2 implements ISubView<PhotoView> {

    private int[] lists;

    private TextView pageTv;

    public SubViewData2(int[] lists, TextView pageTv) {
        this.lists = lists;
        this.pageTv = pageTv;
    }
    ...
    public void loadData(int page, PhotoView view) {
        Glide.with(view.getContext()).load(lists[page]).asBitmap().into(view);
    }
